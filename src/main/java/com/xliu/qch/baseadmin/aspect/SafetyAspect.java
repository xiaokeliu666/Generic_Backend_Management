package com.xliu.qch.baseadmin.aspect;
...
public class SafetyAspect {
     ...
     */
    @Pointcut(value = "execution(public * com.xliu.qch.baseadmin.sys.*.controller.*.*(..)) || " +
            "execution(public * com.xliu.qch.baseadmin.*.controller.*.*(..))")
