...
function updatePassword() {
    let html = "<form id=\"updatePassword\" class=\"layui-form layui-form-pane\">\n" +
        ...
        "\t\t<label class=\"layui-form-label\" style='width: 110px !important;'>Origin Password</label>\n" +
        "\t\t<div class=\"layui-input-block\">\n" +
        "\t\t\t<input type=\"text\" name=\"oldPassword\" autocomplete=\"off\"\n" +
        "\t\t\t\t   placeholder=\"Origin Password\" class=\"layui-input\">\n" +
        "\t\t</div>\n" +
        "\t</div>\n" +
        "\t<div class=\"layui-form-item\">\n" +
        "\t\t<label class=\"layui-form-label\"  style='width: 110px !important;'>New Password</label>\n" +
        "\t\t<div class=\"layui-input-block\">\n" +
        "\t\t\t<input type=\"text\" name=\"newPassword\" autocomplete=\"off\"\n" +
        "\t\t\t\t   placeholder=\"New Password\" class=\"layui-input\">\n" +
        "\t\t</div>\n" +
        "\t</div>\n" +
        "\t<div class=\"layui-form-item\">\n" +
        "\t\t<div class=\"layui-input-block\">\n" +
        ...
        "        if (data.flag) {\n" +
        "            layer.msg('Your password has been reset, please login!', {icon: 1, time: 2000}, function () {\n" +
